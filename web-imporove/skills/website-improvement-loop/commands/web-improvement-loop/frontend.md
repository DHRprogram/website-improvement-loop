...
argument-hint: "[--focus=design|perf|a11y|seo|mobile] [--max-iterations N] [--min-severity P0|P1|P2|P3] [--dry-run] [--agents S1-S10]"
...
- `--agents=S1-S10` — explicit subagent list, overrides `--focus`
